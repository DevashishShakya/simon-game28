//Initial References
const countValue = document.getElementById("count"); //: References the element with the id "count"
const colorPart = document.querySelectorAll(".color-part"); //References all elements with the class "color-part"
const container = document.querySelector(".container"); // References the element with the class "container"
const startButton = document.querySelector("#start"); // References the element with the id "start"
const result = document.querySelector("#result"); // References the element with the id "result"
const wrapper = document.querySelector(".wrapper"); // References the element with the class "wrapper"

//Mapping Colors By Creating Colors Object // to switch between colors
const colors = {
  color1: {
    current: "#068e06",
    new: "#11e711",
...
let randomColors = [];
let pathGeneratorBool = false; // sequence generator is not active
let count,
  clickCount = 0; // count made
